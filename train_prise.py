...
class Workspace:
    def __init__(self, cfg, rank, world_size):
        ...
        obs_shape = [3*self.cfg.frame_stack]+list(self.cfg.img_res)  
    ...
    def setup_replay_buffer(self):
        ...
        ### Create Data Loader
        ### Stage I: Concatenate all data from 45 tasks
        ### Stage III: Only the downstream task
        if self.cfg.stage == 1:
    ...
    ###### Stage II: Use BPE to compute skill tokens
    def train_bpe(self):
    ...
    def downstream_adapt(self):
        ...
        self.agent.taco_opt = torch.optim.Adam(self.agent.PRISE.parameters(), lr=self.cfg.lr)
